...
class DrugsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $drug = new Drugs(["name"=> "Strepsils Extra Blackcurrant Lozenges" ,"description" => "If suffering from painful sore throat try Strepsils Extra Blackcurrant Lozenges containing Hexylresorcinol 2.4mg - an ingredient which is both antiseptic to fight throat infections but also has local anaesthetic properties to numb throat pain." , "image" => "STREPSILS_EXTRA_BLACKCURRANT.jpg" ]); 
        $drug->save();
