...
class DrugSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $drug = new Drug(["name"=> "Strepsils Soothing Throat Spray" ,"description" => "
        ...
        $drug = new Drug(["name"=> "COLDREX pills, 12 pcs." ,"description" => "Short-term tablets for relieving symptoms of the common cold and flu, including headache, sore throat, nasal breathing difficulties, sinusitis, and acute sinusoidal." , "image" => "coldrex_tabletes_12_gab.jpg" ]); 
        $drug->save();

        $drug = new Drug(["name"=> "COLDREX HotRem Lemon sachets, 10 pcs." ,"description" => "Powder for oral solution to temporarily relieve flu and cold symptoms. For example, headache, high fever, chills, sore throat, aching and sharp pain, difficulty breathing through the nose, sinusitis and associated pain and acute runny nose." , "image" => "coldrex_hotrem_lemon_pacinas_10_gab.jpg" ]); 
        $drug->save();
        ...
        $drug = new Drug(["name"=> "COLDREX HotRem Honey & Lemon sachets, 10 pcs." ,"description" => "For the temporary relief of severe cold and flu symptoms, including fever, chills, headache, limb pain, nasal congestion, sore throat, sinusitis and associated pain, and coryza." , "image" => "coldrex_hotrem_honey_lemon_pacinas_10_gab.jpg" ]); 
        $drug->save();
        ...
        $drug = new Drug(["name"=> "PANADOL 120 mg/5 ml suspension, 100 ml" ,"description" => "The active ingredient in this medicine is paracetamol. Panadol is used to relieve mild to moderate pain and reduce fever. Suitable for babies and children from 1 month to 12 years old." , "image" => "panadol_120_mg_5_ml_suspensija_100_ml.jpg" ]); 
        $drug->save();

        $drug = new Drug(["name"=> "NUROFEN Chldren suspension, 100 ml" ,"description" => "Nurofen relieves the condition by altering the body's response to heat, pain and swelling.
        ...
        * Relieve toothache, toothache, ear pain, neck pain, headache and mild sprain pain.
        ...
        $drug = new Drug(["name"=> "NUROFEN FORTE EXPRESS 400 mg pills, 12 pcs." ,"description" => "Nurofen Forte Express contains ibuprofen, which belongs to a group of medicines called non-steroidal anti-inflammatory drugs (NSAIDs). NSAIDs relieve the condition by altering the body's response to pain, swelling, and fever.
        Nurofen Forte Express soothes:
        ...
        $drug = new Drug(["name"=> "ASPIRIN-C effervescent tablets, 10 pcs." ,"description" => "Aspirin C is an analgesic and antipyretic agent used to relieve symptoms of headache, toothache, cervical, menstrual, muscle and joint pain, back pain, and mild arthritis pain. To relieve pain and fever in case of colds and fevers." , "image" => "aspirin_c_putojosas_tabletes_10_gab.jpg" ]); 
        $drug->save();

        $drug = new Drug(["name"=> "JONAX Antistress + B pills, 25 pcs." ,"description" => "Food supplement. It has a calming, cardiotonic and tonic effect. The medicinal herbs included in the composition have a beneficial effect on the body in case of nervous tension, irritability, sleep problems and heart rhythm disturbances" , "image" => "jonax_antistress_b_tabletes_25_gab.jpg" ]); 
        $drug->save();

        $drug = new Drug(["name"=> "STOP STRESS (1 + 1) capsules, 30 pcs." ,"description" => "STOP. STRESS® - a stress protection formula - contains 17 components useful for the human body: vitamins, amino acids, trace elements and plant extracts.
        ...
        $drug = new Drug(["name"=> "STOP STRESS Night (1 + 1) capsules, 30 pcs.","description" => "STOP STRESS Night is a natural keeper of your sleep. The product consists of medicinal herbs, essential amino acids and a natural bioregulator.
        ...
        $drug = new Drug(["name"=> "NERVOSTRONG capsules, 30 pcs." ,"description" => "Anxiety, anxiety, bad mood, increased irritability and nervousness, nervous exhaustion, apathy, tearfulness, poor sleep and sleep disturbances are just some of the signs that indicate that our nervous system is weakened, overworked and needs help.
        ...
        $drug = new Drug(["name"=> "RELAXEN Caps capsules, 30 pcs." ,"description" => "RELAXEN CAPS is a natural herbal complex with a calming effect, promotes emotional balance and stabilizes mood." , "image" => "relaxen_caps_kapsulas_30_gab.jpg" ]); 
        $drug->save();

        $drug = new Drug(["name"=> "RELAXEN Forte pills, 20 pcs." ,"description" => "Relaxen Forte medicinal herbs soothe and balance the nervous system. Melissa and hawthorn contribute to relaxation and rest. Valerian and hops naturally reduce irritability, help you fall asleep, and maintain good sleep quality. Motherwort improves the functioning of the nervous system." , "image" => "relaxen_forte_tabletes_20_gab.jpg" ]); 
        $drug->save();

        $drug = new Drug(["name"=> "SEDANORM capsules, 30 pcs." ,"description" => "Sedanorm - Griffonia Seed Extract helps maintain normal nervous system and brain function." , "image" => "sedanorm_kapsulas_30_gab.jpg" ]); $drug->save();
