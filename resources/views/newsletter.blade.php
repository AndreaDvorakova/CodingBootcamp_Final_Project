...
<body>
    <img class="newsletter__header_image" src="http://www.ipillgood.test/newsletter.jpg" alt="Newsletter header image">
    ...
    <div class="mail__row">
        ...
        <div class="mail__row_right">
            ...
            <img src="http://www.ipillgood.test/images/drugs/{{$test_data[0]->image}}" alt="Pill Image"> 
            <a href="http://www.ipillgood.test/drugs/{{$test_data[0]->id}}/detail"><button>Discover more</button></a>           
        </div>      
    </div>
        ...
        <div class="mail__row_right">
            ...
            <img src="http://www.ipillgood.test/images/drugs/{{$test_data[1]->image}}" alt="Pill Image"> 
            <a href="http://www.ipillgood.test/drugs/{{$test_data[1]->id}}/detail"><button>Discover more</button></a>           
        </div> 
        <p>
